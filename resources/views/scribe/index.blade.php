...
<head>
    ...
    <title>CarRent Documentation</title>
...
<div class="tocify-wrapper">
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: September 3, 2023</li>
    </ul>
</div>
...
<div class="bash-example">
    ...
    --data "{
    \"name\": \"cysmjfuzihtyuaxj\",
    \"email\": \"teagan19@example.org\",
    \"password\": \"et\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="cysmjfuzihtyuaxj"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>cysmjfuzihtyuaxj</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="teagan19@example.org"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>teagan19@example.org</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"email\": \"wallace91@example.com\",
    \"password\": \"~bnK6^mkP&gt;-;e%2PBT&gt;U\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="wallace91@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>wallace91@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="~bnK6^mkP>-;e%2PBT>U"
               data-component="body">
    <br>
<p>Example: <code>~bnK6^mkP&gt;-;e%2PBT&gt;U</code></p>
        </div>
        </form>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="sabryna44@example.org"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>sabryna44@example.org</code></p>
        </div>
        </form>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="crussel@example.org"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>crussel@example.org</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/verify-email/et/eos" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/verify-email/et/eos"
);
...
access-control-allow-origin: http://localhost:3000
access-control-allow-credentials: true
set-cookie: XSRF-TOKEN=%3D; expires=Sun, 03 Sep 2023 11:53:26 GMT; Max-Age=7200; path=/; samesite=lax; carrent_session=%3D; expires=Sun, 03 Sep 2023 11:53:26 GMT; Max-Age=7200; path=/; httponly; samesite=lax
 </code></pre></details>         <pre>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the verify email. Example: <code>et</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
